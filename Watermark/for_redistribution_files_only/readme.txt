Packaging and Deploying Watermark
...
2. Installing the Watermark Package

A. Go to the directory that contains the file setup.py and the subdirectory Watermark. If 
...
3. Using the Watermark Package

The Watermark package is on your Python path. To import it into a Python script or 
